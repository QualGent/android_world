...
def load_and_setup_env(
  ...
  Args:
    ...
    cloud_ip: Cloud emulator IP address (optional, for remote emulators).

  Returns:
    An interactable Android environment.
  """
  env = _get_env(console_port, adb_path, grpc_port, cloud_ip)
